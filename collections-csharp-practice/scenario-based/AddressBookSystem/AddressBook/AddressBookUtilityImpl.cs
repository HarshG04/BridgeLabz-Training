namespace AddressBookSystem
{
    class AddressBookUtilityImpl : IAddressBook
    {
        ...
        internal Dictionary<string,List<Contact>> personByCity = new Dictionary<string,List<Contact>>(); // mantaining a Dictionary Of City and Person
        internal Dictionary<string,List<Contact>> personByState = new Dictionary<string,List<Contact>>(); // mantaining a Dictionary Of State and Person
        ...
        public void AddNewAddressBook()
        {
            ...
            {                
                ...
                {
                    throw new InvalidAddressBookException("Address Book Name Already Exists");
                }
        ...
        public AddressBook SelectAddressBook()
        {
            ...
            {                    
                ...
                {
                    throw new InvalidAddressBookException("No Address Books Available");
                }
                ...
                {
                    throw new InvalidAddressBookException($"No Address Book Has Found Of Name : {userChoise}");
                }
            }
            catch(InvalidAddressBookException e)
            {
